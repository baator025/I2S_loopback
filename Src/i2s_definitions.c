...
const I2sConfig i2s_configurations[NUMBER_OF_CONFIGS] =
{
    ...
    {.clk_pin = {.pin_bank = GPIOC,
                ...
                .afr_pin_position = GPIO_AFRH_AFSEL10_Pos,
                .afr_register_index = 1,
                .ospeedr_pin_position = GPIO_OSPEEDR_OSPEED10_Pos},
    .data_pin = {.pin_bank = GPIOC,
                ...
                .afr_register_index = 1,
                .ospeedr_pin_position = GPIO_OSPEEDR_OSPEED12_Pos},
    .ws_pin = {.pin_bank = GPIOA,
                .pin_mode_position = GPIO_MODER_MODE15_Pos,
                .rcc_pin_bank_position = RCC_AHB1ENR_GPIOAEN,
                .afr_value = I2S3_PIN_ALTERNATE_FUNCTION,
                .afr_pin_position = GPIO_AFRH_AFSEL15_Pos,
                .afr_register_index = 1,
                .ospeedr_pin_position = GPIO_OSPEEDR_OSPEED15_Pos},
    ...
    .data_pin = {.pin_bank = GPIOE,
                ...
                .afr_register_index = 1,
                .ospeedr_pin_position = GPIO_OSPEEDR_OSPEED14_Pos},
        .ws_pin = {.pin_bank = GPIOE,
                .pin_mode_position = GPIO_MODER_MODE11_Pos,
                .rcc_pin_bank_position = RCC_AHB1ENR_GPIOEEN,
                .afr_value = I2S4_PIN_ALTERNATE_FUNCTION,
                .afr_pin_position = GPIO_AFRH_AFSEL11_Pos,
                .afr_register_index = 1,
                .ospeedr_pin_position = GPIO_OSPEEDR_OSPEED11_Pos},
